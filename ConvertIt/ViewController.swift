...
class ViewController: UIViewController {
    ...
    let formulasArray = [Formula(conversionString: "kmiles to kilometers", formula: {$0/0.62137}),
                         ...
                         Formula(conversionString: "cm to inches", formula: {$0 * 0.39377}),
                         Formula(conversionString: "fahrenheit to celsius", formula: {($0-32) * (5/9)}),
                         Formula(conversionString: "celsius to fahrenheit", formula: {($0-32) * (5/9)}),
